namespace Elasticsearch.Infrastructure.Adapter
{
        ...
        : ITypeAdapterFactory
    {
        ...
        public AutomapperTypeAdapterFactory()
        {
            ...
            var assembliesToScan = AppDomain.CurrentDomain.GetAssemblies().Where(a => a.FullName.StartsWith("Elasticserach.Service.SeedWork") && a.FullName.Contains("DTO")).ToArray();
